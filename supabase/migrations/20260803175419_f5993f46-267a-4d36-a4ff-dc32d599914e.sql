...
grant select, insert, update, delete on public.mentorship_profiles to authenticated;
grant select, insert, update, delete on public.mentorship_cohorts to authenticated;
grant select, insert, update, delete on public.mentorship_enrollments to authenticated;
grant select, insert, update, delete on public.mentorship_weeks to authenticated;
grant select, insert, update, delete on public.mentorship_onboarding_tasks to authenticated;
grant select, insert, update, delete on public.mentorship_resources to authenticated;
grant select, insert, update, delete on public.mentorship_onboarding_progress to authenticated;
grant select, insert, update, delete on public.mentorship_baselines to authenticated;
grant select, insert, update, delete on public.mentorship_submissions to authenticated;
grant select, insert, update, delete on public.mentorship_submission_files to authenticated;
grant select, insert, update, delete on public.mentorship_feedback to authenticated;
grant select, insert, update, delete on public.mentorship_calls to authenticated;
grant select, insert, update, delete on public.mentorship_call_attendance to authenticated;
grant select, insert, update, delete on public.mentorship_surgeries to authenticated;
grant select, insert, update, delete on public.mentorship_check_ins to authenticated;
grant select, insert, update, delete on public.mentorship_events to authenticated;
grant all on public.mentorship_profiles to service_role;
grant all on public.mentorship_cohorts to service_role;
grant all on public.mentorship_enrollments to service_role;
grant all on public.mentorship_weeks to service_role;
grant all on public.mentorship_onboarding_tasks to service_role;
grant all on public.mentorship_resources to service_role;
grant all on public.mentorship_onboarding_progress to service_role;
grant all on public.mentorship_baselines to service_role;
grant all on public.mentorship_submissions to service_role;
grant all on public.mentorship_submission_files to service_role;
grant all on public.mentorship_feedback to service_role;
grant all on public.mentorship_calls to service_role;
grant all on public.mentorship_call_attendance to service_role;
grant all on public.mentorship_surgeries to service_role;
grant all on public.mentorship_check_ins to service_role;
grant all on public.mentorship_events to service_role;
...
insert into public.mentorship_cohorts (
  slug, internal_name, display_name, status, current_week, timezone
)
values (
  'cohort-2', 'Cohort 2', 'Rob Late''s Producer Mentorship', 'draft', 1, 'Europe/London'
)
on conflict (slug) do nothing;

insert into public.mentorship_weeks (
  cohort_id, week_number, title, short_title, brief, required_ideas, song_required, stems_required
)
...
insert into public.mentorship_onboarding_tasks (
  cohort_id, task_key, title, description, action_label, position, required
)
...
insert into public.mentorship_resources (
  cohort_id, resource_key, resource_kind, title, description, duration_label, position, published
)

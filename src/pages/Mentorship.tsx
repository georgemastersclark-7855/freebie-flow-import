    ...
    <div className="min-h-screen bg-[#050505] text-white/90">
      <div className="max-w-2xl mx-auto px-6 py-16 font-sans">
        ...
        <p className="text-[15px] leading-relaxed text-white/80 mb-6">
          The next cohort starts in September and applications are opening soon. Get on the waitlist below and I'll personally email you before spots open.
        </p>

        {/* CTA */}
        <a
          href="mailto:team@roblate.com?subject=WAITLIST&body=Hey%20Rob%2C%0A%0AI%27d%20like%20to%20be%20added%20to%20the%20waitlist%20for%20the%20September%20mentorship%20cohort.%0A%0AThanks%2C"

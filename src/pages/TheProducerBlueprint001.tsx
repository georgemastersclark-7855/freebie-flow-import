      ...
      <section className="relative w-full bg-black pt-12 pb-24 px-4 overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto z-10">
          ...
          <div className="text-center mb-24 space-y-4">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-[1.1] md:leading-none">
              Rob Late.{" "}
              <span className="relative inline-block">
                Producer.
                {/* Floating Verified Badge - Superscript Position */}
                <div className="absolute -top-1 -right-3 md:-top-2 md:-right-6">
                  <svg 
                    viewBox="0 0 22 22" 
                    className="h-4 w-4 md:h-7 md:w-7 fill-[#0095F6] drop-shadow-[0_0_15px_rgba(0,149,246,0.3)]"
                    aria-label="Verified"
                  >
        ...
        <section id="testimonials" className="relative py-12 md:py-24 overflow-hidden scroll-mt-20">
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            {(() => {
              ...
              const containerClassName = "flex flex-nowrap overflow-x-auto snap-x snap-mandatory gap-4 pb-8 -mx-6 px-6 md:grid md:grid-cols-3 md:gap-8 md:overflow-visible md:pb-0 md:mx-0 md:px-0 scrollbar-hide mb-20";

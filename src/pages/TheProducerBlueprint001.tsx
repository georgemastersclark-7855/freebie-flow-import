  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans relative overflow-hidden">
      ...
      <main className="relative z-10 px-6 md:px-12 pt-8 md:pt-24 pb-4 md:pb-32 max-w-5xl mx-auto text-center">
        ...
        <div className="w-full relative z-20 my-12 md:my-24 border-none" style={{ border: 'none' }}>
          <p className="text-xs font-bold text-zinc-500 uppercase tracking-[0.2em] mb-6 text-center">
            ROB LATE CREDITS
          </p>

          {/* Gradient Fades for Smooth Edges */}
          <div className="relative overflow-hidden border-none" style={{ border: 'none' }}>
            ...
            <div 
              className="flex whitespace-nowrap gap-16 md:gap-24 items-center animate-marquee"
              style={{
                animation: 'marquee 20s linear infinite',
              }}
            >
              {/* Credits duplicated 4 times for seamless loop */}
              {[0, 1, 2, 3].map((setIndex) => (
                <div key={setIndex} className="flex gap-16 md:gap-24 items-center shrink-0">
                  <div className="flex flex-col items-center shrink-0">
                    <p className="text-white font-black text-sm md:text-base tracking-[0.2em] uppercase">Spinnin' Records</p>
                    <p className="text-zinc-500 text-[10px] md:text-xs mt-1 tracking-wider">Official Remix</p>
                  </div>
                  <div className="flex flex-col items-center shrink-0">
                    <p className="text-white font-black text-sm md:text-base tracking-[0.2em] uppercase">The Chainsmokers</p>
                    <p className="text-zinc-500 text-[10px] md:text-xs mt-1 tracking-wider">Tennis Court</p>
                  </div>
                </div>
              ))}
            </div>

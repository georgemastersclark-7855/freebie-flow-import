    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans relative overflow-hidden">
      ...
      <section className="py-24 px-6 bg-[#050505] relative z-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {/* FIX: Desktop height fixed to 800px to allow vertical spreading (ZigZag).
          ...
          */}
          ...
          <div className="relative h-auto lg:h-[800px]">
            ...
            {/* DESKTOP CENTRAL LINE (Fixed to absolute center, z-0 to sit BEHIND images) */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-4 relative h-full">

              

              {/* ITEM 1: 2019 (TOP) */}

              {/* FIX: justify-start keeps it at the top. z-10 ensures it floats OVER the line/dot. */}

              <div className="relative flex flex-col justify-center lg:justify-start h-full z-10 pointer-events-none lg:pointer-events-auto">

                {/* Dot: Absolute center of column, z-0 to sit BEHIND */}

                <div className="absolute left-8 lg:left-1/2 top-0 lg:top-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-[#050505] border-2 border-[#FF4F33] rounded-full z-0 shadow-[0_0_10px_#FF4F33]"></div>

                

                {/* Content */}

                <div className="pl-20 lg:pl-0 w-full group relative z-10 pointer-events-auto"> 
              ...
              {/* FIX: justify-end pushes it to the bottom. */}

              <div className="relative flex flex-col justify-center lg:justify-end h-full z-10 pointer-events-none lg:pointer-events-auto">
                ...
                <div className="pl-20 lg:pl-0 w-full group relative z-10 pointer-events-auto mt-12 lg:mt-0">
              ...
              <div className="relative flex flex-col justify-center lg:justify-start h-full z-10 pointer-events-none lg:pointer-events-auto">
                ...
                <div className="absolute left-8 lg:left-1/2 top-0 lg:top-1/2 -translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-[#FF4F33] rounded-full z-0 shadow-[0_0_20px_#FF4F33] animate-pulse"></div>

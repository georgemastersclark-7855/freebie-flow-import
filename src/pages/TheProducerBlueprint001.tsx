      ...
      <section className="relative py-24 px-4 md:px-6 bg-[#050505]">
        ...
        <div className="max-w-3xl mx-auto relative z-10 pt-8">
          ...
          <div className="text-center mb-12">
            ...
            {/* Subhead */}
            <p className="text-zinc-400 text-lg">
              Join today and get <span className="text-[#FF4F33] font-bold underline decoration-[#FF4F33]/50 decoration-2 underline-offset-4">2 exclusive bonuses</span> included.
            </p>
          </div>

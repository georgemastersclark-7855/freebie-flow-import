        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <div className="relative w-full bg-zinc-900 rounded-[24px] border border-white/10 overflow-hidden shadow-2xl">
              ...
              {/* Vidalytics Embed */}
              <div
                id="vidalytics_embed_iZTJyib6xT9dwcHs"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10 md:mb-16 relative z-10">
            ...
            <h2 className="text-4xl md:text-6xl font-semibold tracking-tight mb-6 text-white leading-[1.1]">
              You Can't Release A Loop.
            </h2>
            <p className="text-zinc-500 text-base md:text-lg font-light max-w-xl mx-auto leading-relaxed">
              You've got hundreds of project files. 8-bar ideas. “Cool concepts” you swore you'd finish. <span className="text-zinc-400">They're still sitting there.</span>
            </p>
          </div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 md:gap-8">
            ...
            <div className="md:w-1/4 space-y-10 md:space-y-16 text-center md:text-right order-2 md:order-1 relative z-10">
              ...
              <div className="space-y-1.5 relative group">
                ...
                <p className="text-zinc-500 text-sm leading-relaxed">
                  You've watched hours of tips and tricks. But nobody showed you a complete workflow you can repeat. So you keep starting… and restarting.
                </p>
              </div>
              ...
              <div className="space-y-1.5 relative">
                ...
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Nobody streams your hard drive. Labels don't sign potential. Artists don't pay for “almost done.” The only music that matters is music that's finished.
                </p>
            ...
            <div className="md:w-1/4 space-y-10 md:space-y-16 text-center md:text-left order-3 relative z-10">
              ...
              <div className="space-y-1.5 relative">
                ...
                <p className="text-zinc-500 text-sm leading-relaxed">
                  You want to release music. Maybe even do this for real. But your output is inconsistent—months apart, never quite at the level you hear in your head.
                </p>
              </div>
              ...
              <div className="space-y-1.5 relative">
                ...
                <p className="text-zinc-500 text-sm leading-relaxed">
                  You know how to start a track. You don't know how to finish one—consistently, confidently, and without losing the vibe.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative isolate mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { id: "03", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg>, title: "Demo To Release-Ready", desc: "Rob's functional mixing and polish process gets your tracks over the line — without overthinking or endless plugin chains." },
                { id: "04", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>, title: "Finish Consistently", desc: "Stop relying on motivation. Build a repeatable system so you can sit down, produce, and actually finish." }
              ].map((card) => (

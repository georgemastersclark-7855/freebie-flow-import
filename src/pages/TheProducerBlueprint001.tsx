      ...
      <section className="relative w-full bg-black pt-12 pb-24 px-4 overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto z-10">
          ...
          <div className="text-center mb-24 space-y-4">
            ...
            <h2 className="flex flex-wrap items-center justify-center text-[42px] md:text-7xl font-black tracking-tighter text-white leading-none">
              <span className="relative inline-block">
                Rob Late
                <svg 
                  viewBox="0 0 22 22" 
                  className="absolute -top-1 md:-top-2 -right-1 md:-right-2 h-4 w-4 md:h-6 md:w-6 fill-[#0095F6] drop-shadow-[0_0_10px_rgba(0,149,246,0.4)]"
                  aria-label="Verified"
                >
              ...
              <span className="ml-3 md:ml-4">Producer.</span>
            </h2>

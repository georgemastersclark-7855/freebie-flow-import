...
{ id: "01", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>, title: "How to go from \"Loop Phase\" to finished record", desc: "Stop hoarding unfinished ideas. Watch Rob's personal workflow for taking a track from a 4-bar loop to a complete arrangement. No rigid frameworks - just the fluid process of actually finishing songs." },
      ...
      <section className="relative w-full bg-black pt-12 pb-24 px-4 overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto z-10">
          ...
          <div className="w-full max-w-7xl mx-auto relative z-20 mt-24 md:mt-32">
              ...
              >
                {[0, 1].map((setIndex) => (
                  <div key={setIndex} className="flex gap-12 items-start shrink-0">
                    ...
                    <div className="flex flex-col items-center w-32 shrink-0 group cursor-pointer">
                      <img src={chainsmokersTennisCourt} className="w-32 h-32 object-cover rounded-lg shadow-lg group-hover:scale-105 transition-transform duration-300" alt="The Chainsmokers - Tennis Court" />
                      <p className="text-white font-bold text-xs mt-4 text-center leading-tight tracking-widest uppercase">The Chainsmokers</p>
                      <p className="text-zinc-500 text-[10px] text-center mt-1">Tennis Court</p>
                    </div>
                    <div className="flex flex-col items-center w-32 shrink-0 group cursor-pointer">
                      <img src={flawesDontBlameMe} className="w-32 h-32 object-cover rounded-lg shadow-lg group-hover:scale-105 transition-transform duration-300" alt="Flawes - Don't Blame Me" />
                    ...
                    <div className="flex flex-col items-center w-32 shrink-0 group cursor-pointer">
                      <img src={januaryAllMyFriends} className="w-32 h-32 object-cover rounded-lg shadow-lg group-hover:scale-105 transition-transform duration-300" alt="January - All My Friends Are Famous" />
                    ...
                    <div className="flex flex-col items-center w-32 shrink-0 group cursor-pointer">
                      <img src={tiandaNothingButLove} className="w-32 h-32 object-cover rounded-lg shadow-lg group-hover:scale-105 transition-transform duration-300" alt="Tianda - Nothing But Love" />

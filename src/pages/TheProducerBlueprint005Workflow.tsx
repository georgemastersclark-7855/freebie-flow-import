          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center py-16 md:py-20 max-w-[700px] mx-auto">
              <p className="text-lg md:text-xl text-zinc-300 leading-relaxed font-medium">
                You've seen what separates producers who finish music from those who don't. It's not talent or knowledge. It's having a complete workflow that takes you from idea to finished track without getting lost along the way. The Producer Blueprint gives you exactly that.
              </p>
            </div>
          </div>
        </section>

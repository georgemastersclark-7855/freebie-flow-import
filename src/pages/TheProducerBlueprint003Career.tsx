  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans relative overflow-hidden">
      ...
      <main className="relative z-10 px-6 md:px-12 pt-8 md:pt-24 pb-4 md:pb-32 max-w-5xl mx-auto text-center">
        ...
        {/* Headline */}
        <h1 className="hero-headline hero-headline-career text-2xl md:text-5xl lg:text-6xl font-black tracking-[-0.05em] leading-[1.1] md:tracking-[-0.04em] md:leading-[1.05] md:font-bold mb-6 md:mb-10 md:max-w-4xl md:mx-auto">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10 md:mb-16 relative z-10">
            ...
            <h2 className="text-4xl md:text-6xl font-semibold tracking-tight mb-6 text-white leading-[1.1]">
              ...
              <span className="font-serif italic text-white">Stay Broke.</span>
            </h2>

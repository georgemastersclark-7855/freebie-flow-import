      ...
      <section className="relative bg-[#050505] z-20 border-t border-white/5 pt-0 pb-0">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 -mt-12 md:z-10 md:-mt-[350px]">
          ...
          <p className="text-base md:text-lg text-zinc-500 font-medium text-center mt-8 mb-10 max-w-2xl mx-auto leading-relaxed">
            Everything Rob uses to <span className="text-zinc-400">produce, mix, and master</span> release-ready tracks from a <span className="text-zinc-400">home studio</span>, and turn that skill into real income. The same workflow behind his sessions with <span className="text-zinc-400">major artists</span>.
          </p>

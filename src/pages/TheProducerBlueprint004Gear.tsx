...
const BelowFold = lazy(() => import("@/components/blueprint/BelowFold004Gear"));
...
const TheProducerBlueprint004Gear = () => {
  ...
  usePageMeta({
    ...
    canonical: "https://audio.roblate.com/produce-without-expensive-gear",
  });

  // Load Vidalytics script — deferred until idle to avoid blocking first paint
  useEffect(() => {
    ...
    // Defer: use requestIdleCallback (or 3s timeout fallback) so it doesn't compete with hero render

...
const TheProducerBlueprint004Gear = () => {
  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      })(window, document, 'Vidalytics', 'vidalytics_embed_sSWZdoufT0LSh9EO', 'https://fast.vidalytics.com/embeds/TEaBLdFh/sSWZdoufT0LSh9EO/');
    `;
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans relative overflow-hidden">
      ...
      <main className="relative z-10 px-6 md:px-12 pt-8 md:pt-24 pb-4 md:pb-32 max-w-5xl mx-auto text-center">
        ...
        {/* Headline */}
        <h1 className="hero-headline text-2xl md:text-5xl lg:text-6xl font-black tracking-[-0.05em] leading-[1.1] md:tracking-[-0.04em] md:leading-[1.05] md:font-bold mb-6 md:mb-10 md:max-w-4xl md:mx-auto">
          Everything you need to produce release-ready music from a home studio, without spending thousands on expensive gear.
        </h1>

        {/* Subheadline */}
        <p className="text-zinc-400 text-base md:text-lg max-w-3xl mx-auto mb-8 md:mb-12 leading-relaxed">
          <span className="text-white font-semibold">Rob Late</span> has produced and engineered tracks with over 100M+ streams, all from a home studio running the same plugins most producers already own. Inside The Producer Blueprint, he breaks down the exact workflow from sound selection to final master.
        </p>
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <div className="relative w-full bg-zinc-900 rounded-[24px] border border-white/10 overflow-hidden shadow-2xl">
              ...
              {/* Vidalytics Embed */}
              <div
                id="vidalytics_embed_sSWZdoufT0LSh9EO"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 md:gap-8">
            ...
            <div className="md:w-1/4 space-y-10 md:space-y-16 text-center md:text-right order-2 md:order-1 relative z-10">
              ...
              {/* Item 2: Gear Won't Fix Your Mix */}
              <div className="rounded-xl border border-zinc-800 bg-gradient-to-b from-zinc-900 via-[#0A0A0A] to-black backdrop-blur-sm p-4 md:p-5 space-y-1.5 relative">
                <h4 className="text-white font-medium text-base md:text-lg">Gear Won't Fix Your Mix</h4>
                <p className="text-zinc-500 text-sm leading-relaxed">
            ...
            <div className="md:w-1/4 space-y-10 md:space-y-16 text-center md:text-left order-3 relative z-10">
              ...
              {/* Item 3: No Start-to-Finish Process */}
              <div className="rounded-xl border border-zinc-800 bg-gradient-to-b from-zinc-900 via-[#0A0A0A] to-black backdrop-blur-sm p-4 md:p-5 space-y-1.5 relative">
                <div className="relative inline-block">
                  <h4 className="text-white font-medium text-base md:text-lg relative z-10">No Start-to-Finish Process</h4>
                ...
                <p className="text-zinc-500 text-sm leading-relaxed">
                  You know bits of everything but have no complete workflow. Every track is a different experiment with no repeatable system.
                </p>
              </div>
              
              {/* Item 4: Polishing Before Building */}
              <div className="rounded-xl border border-zinc-800 bg-gradient-to-b from-zinc-900 via-[#0A0A0A] to-black backdrop-blur-sm p-4 md:p-5 space-y-1.5 relative">
                ...
                <h4 className="text-white font-medium text-base md:text-lg">Polishing Before Building</h4>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Hours spent tweaking kicks and EQ curves on tracks that were never structured properly in the first place.
                </p>
              </div>
            </div>
          </div>
...
export default TheProducerBlueprint004Gear;

...
function AdminHome() {
  ...
  return hash === "#review-queue"
    ? <Navigate to="/mentorship-demo/admin/reviews" replace />
    : <AdminDashboard />;
}

export default function MentorshipPortal() {
  usePageMeta({
    title: "Mentorship Preview | Rob Late Audio",
    description:
      "Explore the student and coach views of Rob Late's Producer Mentorship with example data.",
    canonical: "https://audio.roblate.com/mentorship-demo",
    ogType: "website",

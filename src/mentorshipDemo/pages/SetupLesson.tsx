...
export function SetupLesson() {
  ...
  if (!lesson || !video) return <div className="mx-auto max-w-3xl p-8"><h1 className="mp-display">Lesson not found</h1><Link to="/mentorship-demo/welcome#setup-videos" className="mp-focus-ring mt-6 inline-flex items-center gap-2 rounded text-sm text-[#f2efe6]"><ArrowLeft size={16} />Back to your setup</Link></div>;
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-4 py-8 sm:px-7 lg:px-10 lg:py-10 xl:px-12">
      <Link to="/mentorship-demo/welcome#setup-videos" className="mp-focus-ring inline-flex items-center gap-2 rounded text-xs font-semibold text-[#b6b3a8]"><ArrowLeft size={14} />Back to your setup</Link>

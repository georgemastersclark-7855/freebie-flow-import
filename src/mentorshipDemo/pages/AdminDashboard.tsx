    ...
    <div className="mx-auto max-w-[1500px] px-4 py-8 sm:px-7 lg:px-10 lg:py-10 xl:px-14">
      ...
      <section className="mt-7 grid gap-6 xl:grid-cols-[1fr_360px]">
        ...
        <aside className="space-y-5">
          <div className="mp-card rounded-3xl p-5"><div className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#77766f]">Rob's queue</div><h2 className="mt-2 text-xl font-bold text-[#ece9e0]">{pendingReviews.length} {pendingReviews.length === 1 ? "submission" : "submissions"} to review</h2><p className="mt-3 text-sm leading-6 text-[#8f8e85]">Open the review queue to listen, leave feedback and pick up saved drafts.</p><Link to="/mentorship-demo/admin/reviews" className="mp-focus-ring mt-5 inline-flex items-center gap-2 rounded-xl bg-[#D3FF02] px-4 py-3 text-sm font-bold text-black">Open review queue <ArrowRight size={16} /></Link></div>

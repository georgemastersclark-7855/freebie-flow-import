...
const studentNavigation = [
  { to: "/mentorship-demo/welcome", label: "Start here", icon: Sparkles },
  { to: "/mentorship-demo/submissions", label: "Your weekly work", icon: FolderClock },
];

const staffNavigation = [
  { to: "/mentorship-demo/admin", label: "Cohort overview", icon: Gauge, adminOnly: false },
  { to: "/mentorship-demo/admin/videos", label: "Manage videos", icon: Video, adminOnly: true },
  { to: "/mentorship-demo/admin#review-queue", label: "Review queue", icon: ClipboardList, adminOnly: false },
];
            ...
            <NavLink
              ...
              className={() => {
                const active = `${location.pathname}${location.hash}` === to
                  || (label === "Start here" && (location.pathname === "/mentorship-demo/welcome" || location.pathname.startsWith("/mentorship-demo/setup/")))
                  || (label === "Your weekly work" && location.pathname.startsWith("/mentorship-demo/week/"))
                  || (label === "Review queue" && location.pathname.startsWith("/mentorship-demo/admin/review/"));
                return cx(

...
export function StudentDashboard() {
  ...
  if (!currentWeek || !currentSubmission) return <div className="p-8 text-sm text-[#aaa99f]">Your weekly workspace is being prepared. <Link to="/mentorship-portal/welcome" className="underline">Go to your setup steps</Link>.</div>;
  ...
  const weekUrl = `/mentorship-portal/week/${currentWeek.number}`;

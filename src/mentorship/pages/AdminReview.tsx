    ...
    <div className="mx-auto max-w-[1280px] px-4 py-8 sm:px-7 lg:px-10 lg:py-10 xl:px-14">
      ...
      <div className="mt-7 grid gap-6 xl:grid-cols-[1fr_390px]">
        ...
        <aside className="space-y-4 xl:sticky xl:top-6 xl:self-start">
          ...
          {published && <div className="rounded-2xl border border-[#9be15d]/20 bg-[#14200f] p-4"><div className="flex items-center gap-2 text-sm font-bold text-[#dff6cb]"><Check size={16} />Feedback sent</div><p className="mt-1 text-xs leading-5 text-[#8fa87b]">The student's email notification has been queued.</p></div>}
        </aside>
      </div>
    </div>
  );

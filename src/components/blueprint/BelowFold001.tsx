...
const BelowFold001 = ({ trackScrollToPricing, trackOrderBumpChecked, trackFinalCheckoutClick, nameRef, emailRef, isLoading, handleCheckout }: BelowFoldProps) => {
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  <div className="shrink-0 w-12 h-12 md:w-14 md:h-14 bg-zinc-900 rounded-lg border border-zinc-800 overflow-hidden">
                    <img src={producerBlueprintThumbnail} alt="Program Thumbnail" className="w-full h-full object-cover" loading="lazy" decoding="async" />
                  </div>

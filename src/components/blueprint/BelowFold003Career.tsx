...
const BelowFold003Career = ({ trackScrollToPricing, trackOrderBumpChecked, trackFinalCheckoutClick, nameRef, emailRef, isLoading, handleCheckout }: BelowFoldProps) => {
...
export default BelowFold003Career;
